...
<div class="container my-lg-2">
   <div class="row mb-4">
      <div class="col-md-8">
         <!--section 1-->
         <div class="box">
            <p class="font-45-700 text-black font-1 my-0" style="line-height: 55px;"> {{$dataa->h1}}</p>
            <div class="row mt-2">
               <div class="para-box">
                  <p>{!! $dataa->contant !!}</p>
               </div>
            </div>
            <a href="{{ $dataa->button_url }}">
            ...
            <div class="article-navigation-btn">
               <div class="nav-btn nav-btn-prev my-auto ">
                  <a href="" class="d-flex flex-column justify-content-center">
                     <div class="text-white font-1">{{!! $dataa->content3 !!}}</div>
                  </a>
               </div>
         ...
         <div class="socialList mt-4">
            ...
            <ul class="list-unstyled">
               <li class="font-23-600 my-3 d-flex">
                  <div class="me-2" style="width: 30px;"><i class="fa-brands fa-facebook-f" style="color: #3e83ec;"></i></div>
                  <a href="#" class="font-1 text-decoration-none text-black">Facebook</a>
               </li>
               <li class="font-23-600 my-3 d-flex">
                  <div class="me-2" style="width: 30px;"><i class="fa-brands fa-twitter" style="color:  #56cce6;"></i></div>
                  <a href="#" class="font-1 text-decoration-none text-black">Twitter</a>
               </li>
               <li class="font-23-600 my-3 d-flex">
                  <div class="me-2" style="width: 30px;"><i class="fa-brands fa-instagram" style="color: #8f59c8;"></i></div>
                  <a href="#" class="font-1 text-decoration-none text-black">Instagram</a>
               </li>
               <li class="font-23-600 my-3 d-flex">
                  <div class="me-2" style="width: 30px;"><i class="fa-brands fa-youtube" style="color: #ed4141;"></i></div>
                  <a href="#" class="font-1 text-decoration-none text-black">YouTube</a>
               </li>
            </ul>
         </div>
      </div>
