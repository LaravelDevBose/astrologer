    ...
    <div class="container my-lg-2">
        <div class="row mb-4">
            <div class="col-md-8">
                <!--section 1-->
               <div class="box">
                <p class="font-45-700 text-black font-1 my-0" style="line-height: 55px;"> {{$pagedata->h1}}</p>
                <div class="row mt-2">
                    <div class="img-box">
                        <img style="width: 100%;height: 100%;" src="{{asset('storage/app/public/'.$pagedata->top_image)}}" class="img-fluid rounded-2" alt="">
                    </div>
               ...
               <!--section 2-->
               <div class="box">
                <p class="font-45-700 text-black font-1 my-0" style="line-height: 55px;"> {{$pagedata->banner_title}}</p>
                <div class="row mt-2">
                    <div class="img-box">
                        <img style="width: 100%;height: 100%;" src="{{asset('storage/app/public/'.$pagedata->banner2_image)}}" class="img-fluid rounded-2" alt="">
                    </div>
