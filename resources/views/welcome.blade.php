							...
							<div class="card-body">
								...
								<div class="table-responsive mt-4">
									<table class="table align-middle mb-0 table-hover" id="Transaction-History">
										<thead class="table-light AllBlack">
											<tr>
												<th>Payment Name</th>
												<th>Date & Time</th>
												<th>Amount</th>
					...
					<div class="col-12 col-xl-6 d-flex">
						<div class="card radius-10 w-100">
							...
							<div class="customers-list p-3 mb-3">
								...
								<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
									<div class="">
										<img src="{{asset("assets/images/avatars/avatar-23.png")  }}" class="rounded-circle" width="46" height="46" alt="" />
									</div>
									<div class="ms-2">
								...
								<div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
									<div class="">
										<img src="{{asset("assets/images/avatars/avatar-24.png")  }}" class="rounded-circle" width="46" height="46" alt="" />
									</div>
									<div class="ms-2">
