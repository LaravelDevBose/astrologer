        ...
        <h5 class="mb-0 text-primary">Edit Dream Interpretation</h5>
        </div>
        <hr>
        <form class="row g-3" method="post" action="{{route('dream.store')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-12">
        <label for="titleName" class="form-label">Banner Heading</label>
        <input type="text" id="heading" name="h3" value="{{$data->h3}}" class="form-control">
        <input type="hidden" name="id" value="{{$data->id}}">
        ...
        <!--<div class="col-md-12">-->
        <!--<label for="titleName" class="form-label">Banner Title</label>-->
        <!--<input type="text" id="titleName" name="banner_title" value="{{$data->banner_title}}" class="form-control">-->
        ...
        <div class="col-md-12">
        <div class="col-12">
        <button type="submit" class="btn btn-primary px-5">Update Dream</button>
        </div>
        </form>
        </div>
        </div>
