        ...
        <div class="breadcrumb-title pe-3">Money And Wealth</div>
        <div class="ps-3">
        <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 p-0">
        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
        </li>
        <li class="breadcrumb-item active" aria-current="page">Money And Wealth</li>
        </ol>
        </nav>
        </div>
        ...
        <h5 class="mb-0 text-primary">Edit Money And Wealth</h5>
        </div>
        <hr>
        <form class="row g-3" method="post" action="{{route('money.update')}}" enctype="multipart/form-data">
        @csrf
        ...
        <input class="form-control" type="file" name="image" id="formFile"value="{{$data->image}}">
         <!-- In your Blade view -->
       <img src="{{asset('storage/images/'.$data->image) }}" alt="No Image">
        ...
        <br/>
        <button type="submit" class="btn btn-primary px-5">Edit Money And Wealth</button>
