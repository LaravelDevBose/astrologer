...
<div class="d-flex justify-content-between">
		...
		<!--end breadcrumb-->
		<a class="btn btn-primary px-5" href="{{route('Article.create')}}">Add</a>
	</div>
	<div class="row">
		<h6 class="mb-0 text-uppercase">Article</h6>
		<hr/>
		@if(session('success'))
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									{!! Form::open([
									'method'=>'GET',
									'route' => ['Article.destroy',$datas->id],
									...
									'title' => 'Delete Zodic',
									'onclick'=>'return confirm("Are you sure about deleting Article?")'
									)) !!}
									{!! Form::close() !!}
								</td>
							</tr>
