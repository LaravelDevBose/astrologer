...
<div class="d-flex justify-content-between">
		...
		<!--end breadcrumb-->
		<a class="btn btn-primary px-5" href="{{route('ArticleCategory.create')}}">Add</a>
	</div>
	<div class="row">
		<h6 class="mb-0 text-uppercase">Article Category</h6>
		<hr/>
		@if(session('success'))
					...
					<table id="example2" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ route('ArticleCategory.edit') }}/{{$datas->id}}">
									...
									{!! Form::open([
									'method'=>'GET',
									'route' => ['ArticleCategory.destroy',$datas->id],
