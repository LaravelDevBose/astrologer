...
<div class="page-content">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3">Compatibility</div>
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0 p-0">
					<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
					</li>
					<li class="breadcrumb-item active" aria-current="page">Compatibility</li>
				</ol>
			</nav>
		</div>
		...
		<div class="mx-auto">
			...
			<div class="card border-top border-0 border-4 border-primary">
				...
				<div class="card-body p-5">
					...
					<hr>
					<form class="row g-3" method="post" action="{{route('Compatibility.edit')}}" enctype="multipart/form-data">
						@csrf
						<div class="col-md-12">
						...
						<div class="col-md-4">
							<label for="titleName" class="form-label">Compatibility Category</label>
						...
						<div class="col-md-12">
							<label for="inputLastName" class="form-label">Compatibility Image</label>
