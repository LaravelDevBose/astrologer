...
<div class="page-content">
	...
	<div class="d-flex justify-content-between">
		...
		<!--end breadcrumb-->
		<a class="btn btn-primary px-5" href="{{route('Zordic.create')}}">Add</a>
	</div>
					...
					<table id="example2" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ route('Zordic.edit') }}/{{$datas->id}}">

										<i class="fadeIn animated bx bx-pencil">
										</i></a>
										
										<a href="{{ route('Zordic.destroy') }}/{{$datas->id}}">
