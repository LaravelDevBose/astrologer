		...
		<div class="mx-auto">
			...
			<div class="card border-top border-0 border-4 border-primary">
				...
				<div class="card-body p-5">
					...
					<hr>
					<form class="row g-3" method="post" action="{{route('ProductCategory.edit')}}" enctype="multipart/form-data">
						@csrf
						<div class="col-md-12">
						...
						<div class="col-md-12">
							...
							<div class="col-sm-3" id="postImage">
								<div class="card position-relative">
									<img src="{{asset('storage/app/public/productcategory')}}/{{$data->thumbImage}}" height="150" class="card-img-top" alt="...">
