...
<div class="page-content">
	...
	<div class="d-flex justify-content-between">
		...
		<!--end breadcrumb-->
		<a class="btn btn-primary px-5" href="{{route('contributor.create')}}">Add</a>
	</div>

	<div class="row">
		<h6 class="mb-0 text-uppercase">Contributor</h6>
		<hr />
		@if(session('success'))
					...
					<table id="example2" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ route('contributor.edit') }}/{{$datas->id}}">
									...
									{!! Form::open([
									'method'=>'GET',
									'route' => ['contributor.destroy',$datas->id],
									...
									'title' => 'Delete Zodic',
									'onclick'=>'return confirm("Are you sure about deleting contributor?")'
									)) !!}
									{!! Form::close() !!}
								</td>
							</tr>
