        ...
        <!--end breadcrumb-->
        <a class="btn btn-primary px-5" href="{{route('addzordicgender')}}">Add</a>
        </div>
        ...
        <!--<th scope="col">ZODIAC SIGN DESCRIPTION</th>-->
        ...
        <td>
        <a href="{{ route('editzordicgender', ['id' => $datas->id]) }}">
        <i class="fadeIn animated bx bx-pencil"></i>
        </a>
        
        {!! Form::open([
        'method'=>'GET',
        'route' => ['destroyzordicgender',$datas->id],
