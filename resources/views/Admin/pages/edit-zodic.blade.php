		...
		<div class="mx-auto">
			...
			<div class="card border-top border-0 border-4 border-primary">
				...
				<div class="card-body p-5">
					...
					<hr>
					<form class="row g-3" method="post" action="{{route('Zordic.edit')}}" enctype="multipart/form-data">
						@csrf
						<div class="col-md-12">
							<label for="titleName" class="form-label">Title</label>
							<input type="text" id="titleName" name="title" value="{{$data->Name}}" class="form-control">
							<input type="hidden" id="zodic_id" name="zodic_id" value="{{$data->id}}">
						...
						<div class="col-md-12">
							...
							<div class="col-sm-3" id="postImage">
								<div class="card position-relative">
									<img src="{{asset('storage/app/public/zordiac')}}/{{$data->Image}}" style="object-fit: contain;" height="150" class="card-img-top" alt="...">
						...
						<div class="col-md-12">
							...
							<select class="form-control" id="Position" name="displayOrder" >
								@for($i=1;$i<=12;$i++)
								 @if(!in_array($i,$getdisplayOrders))
