    ...
    <!--end breadcrumb-->
    <a class="btn btn-primary px-5" href="{{route('create-planet')}}">Add</a>
    </div>
    ...
    <td>
    <a href="{{ route('Planet.edit', ['id' => $datas->id]) }}">
    <i class="fadeIn animated bx bx-pencil"></i>
    </a>
    
    {!! Form::open([
    'method'=>'GET',
    'route' => ['Planet.destroy',$datas->id],
    ...
    'title' => 'Delete Zodic',
    'onclick'=>'return confirm("Are you sure about deleting Planet?")'
    )) !!}
    {!! Form::close() !!}
