    ...
    <h5 class="mb-0 text-primary">Add Planet</h5>
    </div>
    <hr>
    ...
    <form class="row g-3" method="post" action="{{route('planet-store')}}"  id="yourForm" enctype="multipart/form-data">
    @csrf
    ...
    <input type="text" id="glyph" name="glyph"
    class="form-control">
    </div>
    
    <div class="col-md-12">
    <label for="ruling_house" class="form-label"> Ruler Of </label>
    <input type="text" id="ruler_of" name="ruler_of"
    class="form-control">
    </div>
    
    <div class="col-md-12">
    <label for="quality" class="form-label">Sign Of Dignity</label>
    <input type="text" id="sign_of_dignity" name="sign_of_dignity"
    class="form-control">
    </div>
    
    <div class="col-md-12">
    <label for="polarity" class="form-label">Sign Of Detriment</label>
    <input type="text" id="sign_of_detriment" name="sign_of_detriment"
    class="form-control">
    </div>
    ...
    <input type="text" id="sign_of_exaltation" name="sign_of_exaltation"
    class="form-control">
    </div>
    
    <div class="col-md-12">
    <label for="polarity" class="form-label">Sign Of Fall</label>
    <input type="text" id="sign_of_fall" name="sign_of_fall"
    class="form-control">
    </div>
    ...
    <input type="text" id="physical_body" name="physical_body"
    class="form-control">
    </div>
    
    <div class="col-md-12">
    <label for="changes_sign" class="form-label"> Changes Sign </label>
    <input type="text" id="changes_sign" name="changes_sign"
    class="form-control">
    </div>
    ...
    <div class="col-12">
    <button type="submit" class="btn btn-primary px-5">Submit Planet</button>
    </div>
    </form>
    </div>
    </div>
