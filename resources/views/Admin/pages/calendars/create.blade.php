    ...
    <h5 class="mb-0 text-primary">Add Calendar</h5>
    </div>
    <hr>
    @if(session('success'))
    ...
    <form class="row g-3" method="post" action="{{route('calendar-store')}}"  id="yourForm">
    @csrf
    ...
    <textarea class="form-control" id="mytextareacontent2" name="content"  rows="4"></textarea>
    </div>
    ...
    <input type="checkbox" id="favorableMajorTransit" name="favorable_major_transit" value="favorable_major_transit">
    </div>
    
    
    <div class="col-md-3">
    <label for="newZodiacSeason">New Zodiac Season</label>
    <input type="checkbox" id="newZodiacSeason" name="new_zodiac_season" value="new_zodiac_season">
     </div>
    
    
    <div class="col-md-3">
    <label for="retrograde">Retrograde</label>
    <input type="checkbox" id="retrograde" name="retrograde" value="retrograde">
    </div>
    
    <div class="col-md-3">
    <label for="moonEvents">Moon Events</label>
    <input type="checkbox" id="moonEvents" name="moon_events" value="moon_events">
     </div>
    
    </div>
    
    <div class="month_detail"></div>
