			...
			<div class="card border-top border-0 border-4 border-primary cardForm">
				...
				<div class="card-body p-5">
					<div class="card-title d-flex align-items-center">
						...
						<h5 class="mb-0 text-primary">Compatibility Category</h5>
					</div>
					<hr>
					<form class="row g-3" method="post" action="{{route('CompatibilityCategory.store')}}" enctype="multipart/form-data">
						@csrf
						<div class="col-md-12">
