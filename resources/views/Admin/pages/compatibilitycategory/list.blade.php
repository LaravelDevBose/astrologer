...
<div class="d-flex justify-content-between">
		...
		<!--end breadcrumb-->
		<a class="btn btn-primary px-5" href="{{route('CompatibilityCategory.create')}}">Add</a>
	</div>
	<div class="row">
		<h6 class="mb-0 text-uppercase">Compatibility Category</h6>
		<hr/>
		@if(session('success'))
					...
					<table id="example2" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ route('CompatibilityCategory.edit') }}/{{$datas->id}}">
									...
									{!! Form::open([
									'method'=>'GET',
									'route' => ['CompatibilityCategory.destroy',$datas->id],
