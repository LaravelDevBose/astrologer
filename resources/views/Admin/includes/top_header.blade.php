		...
		<div class="topbar d-flex align-items-center">
				<nav class="navbar navbar-expand">
					<div class="topbar-logo-header">
						<div class="">
							<img src="{{asset('assets/images/icons/logo.svg')}}" style="width: 160px;" class="logo-icon" alt="logo icon">
						</div>
					...
					<div class="user-box dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item" href="adminLogout"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
