...
class AstrologyApiClient extends Model
{
    private $userId = null;
    private $apiKey = null;
    ...
    */
    ...
    public function matchBirthDetails(array $maleBirthData, array $femaleBirthData)
    {
        ...
        $response = self::getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, $this->language);
        return $response;
    }
    ...
    /*public function getNumeroGemSuggestion($date, $month, $year, $name)
    {
        ...
        $data = $this->packageNumeroData($date, $month, $year, $name);
        $response = self::getCurlReponse($this->userId, $this->apiKey, $resourceName, $data);
        return $response;
    }*/
    ...
    public function timezoneWithDst( $date, $latitude, $longitude)
    {
        ...
        $resData = self::getCurlReponse($this->userId, $this->apiKey,$resourceName, $data,$this->language);
        return $resData;
    }
    ...
    public function getWesternHoroscope($date, $month, $year, $hour, $minute, $latitude, $longitude, $timezone, $settings = array()){
        ...
        $response = self::getCurlReponse($this->userId, $this->apiKey, $resourceName, $data, 'en');
        return $response;
    ...
    public function callApi($endPoint, $data){
        $response = self::getCurlReponse($this->userId, $this->apiKey, $endPoint, $data, $this->language);
        return $response;
    }



    public function getCurlReponse($userId, $apiKey, $resource, array $data, $language) {
