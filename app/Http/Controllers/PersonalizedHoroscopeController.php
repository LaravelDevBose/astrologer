...
class PersonalizedHoroscopeController extends Controller
{
    ...
    public function submitForm(Request $request)
    {
        ...
        $horoscopeData->birth_year = $request->get('birth_year');
        $horoscopeData->birth_time_know = $request->get('birth_time_know');
        $horoscopeData->birth_time = $request->get('birth_time');
        ...
        Mail::to(env('ADMIN_EMAIL'))->send(new Personalisedform([
            ...
            'birth_time_know' => $request->get('birth_time_know'),
